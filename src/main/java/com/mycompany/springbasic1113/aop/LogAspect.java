...
public class LogAspect {
    ...
    // @Before(value = "execution(public int com.mycompany.springbasic1113.aop.CalcImpl.*(int, int))") // 切入點表達式
    // @Before(value = "execution(public int com.mycompany.springbasic1113.aop.*.*(int, int))") // 切入點表達式
    // @Before(value = "execution(* com.mycompany.springbasic1113.aop.*.*(..))") // 切入點表達式
